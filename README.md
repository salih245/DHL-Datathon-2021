...
<ol>
<p><em>add the newly placed orders and the orders that haven&rsquo;t shipped to checklist</em></p>
<p><em> move the items that should be picked that day from checklist to picking_list</em></p>
<p><em> pick all the items from picking_list</em></p>
</ol>
